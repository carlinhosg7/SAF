...
def render_nova_saf_alterar_portador_devolucao(dados=None, nome_atendente=""):
    dados = dados or {}
    ...
    return f"""
    <div class="panel">
        <h3>ALTERAR PORTADOR PARA DEVOLUÇÃO (MOTIVO)</h3>
        <p class="hint">Informe o cliente e adicione os títulos que entrarão na SAF.</p>

        <input type="hidden" name="tipo_saf" value="ALTERAR_PORTADOR_DEVOLUCAO">

        <div class="grid-3">
            <div class="field">
                <label>Código do Cliente</label>
                <input type="text" id="codigo_cliente" name="codigo_cliente" value="{escape(str(codigo_cliente))}" placeholder="Digite o código do cliente" onblur="carregarTitulosCliente()">
            </div>
        ...
        <div class="grid-2">
            <div class="field">
                ...
                <textarea id="observacao" name="ocorrencia_geral" rows="4" placeholder="Descreva o motivo da alteração do portador para devolução">{escape(str(ocorrencia_geral))}</textarea>
            </div>
        ...
        <div class="panel" style="margin-top:16px;">
            <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;">
                ...
                <input type="text" id="busca_titulo" placeholder="Pesquisar título" oninput="filtrarTitulosCliente()" style="max-width:260px;">
            </div>

            <div id="lista_titulos_cliente" style="margin-top:12px;"></div>
        </div>

        <div id="alterar_portador_total_geral" class="panel" style="margin-top:16px;">
